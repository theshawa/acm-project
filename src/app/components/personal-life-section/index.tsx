  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row page-space-x">
        <div className="flex flex-col w-full lg:w-[50%] lg:mr-10 lg:sticky lg:top-[16vh] h-max mx-auto lg:mx-0 max-w-lg scroll-appear">
        ...
        <div className="flex flex-col space-y-10 lg:w-[40%] ml-auto mr-auto lg:mr-0 max-w-lg w-full mt-20 lg:mt-0 lg:pt-[50vh]">
